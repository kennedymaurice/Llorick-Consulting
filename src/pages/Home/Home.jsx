...
const Home = () => {
    return (
        <main className="bg-white text-slate-900">
                    ...
                    <div className="grid gap-14 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
                        ...
                        <div>
                            <p className="text-lg leading-9 text-slate-600">
                                ...
                                institutions to translate evidence into
                                practical solutions. We work across the public
                                health and development ecosystem to strengthen
                                programs, improve decision-making, support
                                implementation, and build institutional
                                capacity.
                            </p>

                            <p className="mt-6 text-lg leading-9 text-slate-600">
                                Our work is grounded in technical expertise,
                                global exposure, community understanding, and a
                                deep commitment to sustainable health outcomes.
                            </p>
                    ...
                    <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {services.map((service) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#0F172A] text-[#C9A24D] transition group-hover:bg-[#C9A24D] group-hover:text-[#0F172A]">
                    ...
                    <div className="mt-12 grid gap-6 md:grid-cols-3">
                        {framework.map((item) => {
                            ...
                            return (
                                <div
                                    key={item.title}
                                    className="rounded-[1.5rem] border border-slate-200 p-8"
                                >
                    ...
                    <div className="grid gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center">
                        ...
                        <div>
                            <p className="text-lg leading-9 text-slate-300">
                                ...
                                Africa, Europe, and North America, with exposure
                                to global health institutions, development
                                agencies, research environments, community
                                health systems, and policy platforms.
                            </p>

                            <p className="mt-6 text-lg leading-9 text-slate-300">
                                This unique perspective enables us to understand
                                public health challenges from the community
                                level to the global policy level.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24">
                <div className="mx-auto max-w-7xl px-5 lg:px-8">
                    <div className="rounded-[2rem] bg-[#F8FAFC] p-8 md:p-14">
                        <div className="max-w-3xl">
                            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#C9A24D]">
                                Research & Insights
                            </p>
